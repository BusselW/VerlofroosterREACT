                    ...
                    h('header', { className: 'header' },
                        h('div', { className: 'header-content' },
                            ...
                            h('div', { className: 'header-acties' },
                                h('button', { className: 'btn btn-secondary', onClick: () => alert('Nog niet geïmplementeerd') },
                                    h('i', { className: 'fas fa-download' }),
                                    'Exporteren'
                                ),
                                h('button', { className: 'btn btn-primary', onClick: () => alert('Nog niet geïmplementeerd') },
                ...
                h('main', { className: 'main-content' },
                    h('table', { className: 'rooster-table' },
                        h('thead', { className: 'rooster-thead' },
                            h('tr', null,
                                h('th', { className: 'medewerker-kolom' }, 'Medewerker'),
                                periodeData.map(dag => {
                                    const isWeekend = dag.getDay() === 0 || dag.getDay() === 6;
                                    const feestdagNaam = checkIsFeestdag(dag);
                                    const classes = `dag-kolom ${isWeekend ? 'weekend' : ''} ${feestdagNaam ? 'feestdag' : ''}`;
                                        ...
                                        h('tr', { key: medewerker.id, className: 'medewerker-rij' },
                                            ...
                                            ...(() => {
                                                ...
                                                return dagenMetBlokInfo.map(({ dag, item, isStart, isEnd, isMiddle, compensatieMomenten }) => {
                                                    ...
                                                    const compensatieMomentenBlokken = compensatieMomenten.map((moment) => {
                                                        const iconBaseUrl = 'https://som.org.om.local/sites/MulderT/CustomPW/Verlof/cpw/react/icons/compensatieuren/';
                                                        let iconSrc = '';
                                                        ...
                                                        switch (moment.type) {
                                                            case 'compensatie':
                                                                iconSrc = `${iconBaseUrl}neutraleuren.svg`;
                                                                title = `Compensatie: ${title}`;
                                                                className += ' neutraal';
                                                                break;
                                                            case 'ruildag-gewerkt':
                                                                iconSrc = `${iconBaseUrl}Plusuren.svg`;
                                                                ...
                                                                break;
                                                            case 'ruildag-vrij':
                                                                iconSrc = `${iconBaseUrl}Minuren.svg`;
