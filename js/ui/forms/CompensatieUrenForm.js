    ...
    useEffect(() => {
        const initializeForm = async () => {
            ...
            if (Object.keys(initialData).length === 0) {
                ...
                setIsRuildag(initialData.Ruildag || false);
                setRuildagStart(initialData.ruildagStart || today);
                setRuildagEinde(initialData.ruildagEinde || today);
    ...
    return h('form', { onSubmit: handleSubmit, className: 'form-container' },
        ...
        h('div', { className: 'form-row' },
            h('div', { className: 'form-groep' },
                ...
                h('select', { className: 'form-select', id: 'comp-medewerker', value: medewerkerId, onChange: handleMedewerkerChange, required: true },
        ...
        h('div', { className: 'form-row' },
            h('div', { className: 'form-groep' },
                h('label', { htmlFor: 'comp-start-datum' }, 'Start gewerkte tijd'),
                h('input', { className: 'form-input', type: 'date', id: 'comp-start-datum', value: startDate, onChange: (e) => setStartDate(e.target.value), required: true })
            ),
            h('div', { className: 'form-groep' },
        ...
        h('div', { className: 'form-row' },
            h('div', { className: 'form-groep' },
                h('label', { htmlFor: 'comp-eind-datum' }, 'Einde gewerkte tijd'),
                h('input', { className: 'form-input', type: 'date', id: 'comp-eind-datum', value: endDate, onChange: (e) => setEndDate(e.target.value), required: true, min: startDate })
            ),
            h('div', { className: 'form-groep' },
        ...
        h('div', { className: 'form-row' },
            h('div', { className: 'form-groep' },
                ...
                h('textarea', { className: 'form-textarea', id: 'comp-omschrijving', rows: 3, value: omschrijving, onChange: (e) => setOmschrijving(e.target.value), placeholder: 'Reden voor compensatie' })
            )
        ),
        ...
        h('div', { className: 'form-row' },
            h('div', { className: 'form-groep form-check' },
                ...
                h('label', { htmlFor: 'comp-ruildag' }, 'Dit is een ruildag (deze uren worden op een andere dag opgenomen)')
            )
        ),

        isRuildag && h('div', { className: 'form-row' },
            h('div', { className: 'form-groep' },
                h('label', { htmlFor: 'comp-ruildag-start' }, 'Startdatum opgenomen vrij'),
                h('input', { className: 'form-input', type: 'date', id: 'comp-ruildag-start', value: ruildagStart, onChange: (e) => setRuildagStart(e.target.value), required: isRuildag })
            ),
            h('div', { className: 'form-groep' },
                h('label', { htmlFor: 'comp-ruildag-einde' }, 'Einddatum opgenomen vrij'),
                h('input', { className: 'form-input', type: 'date', id: 'comp-ruildag-einde', value: ruildagEinde, onChange: (e) => setRuildagEinde(e.target.value), required: isRuildag, min: ruildagStart })
            )
        ),
