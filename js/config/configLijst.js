...
if (typeof window.appConfiguratie === 'undefined') {
  ...
  window.appConfiguratie = {
    ...
    "CompensatieUren": {
      ...
      "baseTemplate": 100,
      "velden": [
        { "titel": "Id", "interneNaam": "ID", "type": "Counter" }, /* niet relevant maar opgenomen voor volledigheid */
        { "titel": "Titel", "interneNaam": "Title", "type": "Text" }, /* Niet relevant maar opgenomen voor volledigheid */
        { "titel": "Medewerker", "interneNaam": "Medewerker", "type": "Text" }, /* Volledige 'gebruikersvriendelijke' naam van de medewerker. */
        { "titel": "AanvraagTijdstip", "interneNaam": "AanvraagTijdstip", "type": "DateTime" }, /* Wanneer de aanvraag is gedaan */
        { "titel": "StartCompensatieUren", "interneNaam": "StartCompensatieUren", "type": "DateTime" }, /* Startdatum en -tijd van de compensatie-uren. Gebruik dit om een nieuw blok in het rooster te maken (startpunt) */
        { "titel": "EindeCompensatieUren", "interneNaam": "EindeCompensatieUren", "type": "DateTime" }, /* Einddatum en -tijd van de compensatie-uren. Gebruik dit om een nieuw blok in het rooster te maken (eindpunt) */
        { "titel": "MedewerkerID", "interneNaam": "MedewerkerID", "type": "Text" }, /* Unieke identificatie voor de medewerker. Bevat domein\gebruikersnaam-formaat (bijv: org\busselw). Gebruik dit om te relateren aan Medewerkers.username */
        { "titel": "Omschrijving", "interneNaam": "Omschrijving", "type": "Text" }, /* Een bericht dat de gebruiker naar zijn/haar manager kan sturen */
        { "titel": "Ruildag", "interneNaam": "Ruildag", "type": "Boolean" }, /* Geeft aan dat de medewerker afwijkt van zijn/haar gebruikelijke werkdag. Door dit op true te zetten, kan de medewerker aangeven dat hij/zij op een andere dag werkt dan normaal. Dit veld behandelt de dag waarop hij/zij eigenlijk zou werken, terwijl het veld StartCompensatieUren de daadwerkelijke werkdag behandelt */
        { "titel": "ruildagEinde", "interneNaam": "ruildagEinde", "type": "DateTime" }, /* De einddatum en -tijd van de ruildag. Dit wordt gebruikt om aan te geven wanneer de medewerker klaar is met werken op een andere dag dan normaal. */
        { "titel": "ruildagStart", "interneNaam": "ruildagStart", "type": "DateTime" }, /* De startdatum en -tijd van de ruildag. Dit wordt gebruikt om aan te geven wanneer de medewerker is begonnen met werken op een andere dag dan normaal. */
        { "titel": "Status", "interneNaam": "Status", "type": "Choice" }, /* De status van de compensatie-uren aanvraag. Dit kan worden gebruikt om bij te houden of de aanvraag 'Nieuw', 'Goedgekeurd' of 'Afgewezen' is. */
        { "titel": "UrenTotaal", "interneNaam": "UrenTotaal", "type": "Text" } /* Totaal aantal uren gecompenseerd door de medewerker. Dit wordt gebruikt om het totaal aantal gecompenseerde uren te berekenen. */
      ]
    },
...
Otherwise, extract values from DagenIndicators.Title
    ...
    "Medewerkers": {
      ...
      "velden": [
        { "titel": "Id", "interneNaam": "ID", "type": "Counter" }, /* niet relevant maar opgenomen voor volledigheid */
        { "titel": "Titel", "interneNaam": "Title", "type": "Text" },
        { "titel": "Naam", "interneNaam": "Naam", "type": "Text" }, /* Volledige 'gebruikersvriendelijke' naam van de medewerker. */
        { "titel": "Geboortedatum", "interneNaam": "Geboortedatum", "type": "DateTime" }, /* Geboortedatum van de medewerker. Dit kan gebruikt worden voor leeftijdsgerelateerde logica of rapportages. */
        ...
        { "titel": "Username", "interneNaam": "Username", "type": "Text" }, /* Unieke identificatie voor de medewerker. Bevat domein\gebruikersnaam-formaat (bijv: org\busselw). Gebruik dit om te relateren aan andere lijsten zoals CompensatieUren, Verlof, etc. */
        { "titel": "Opmerking", "interneNaam": "Opmekring", "type": "Note" }, /* 'Opmekring' is correct en dient niet te worden aangepast. */
