...
if (typeof window.appConfiguratie === 'undefined') {
    ...
    window.appConfiguratie = {
         ...
         * @description Definieert de SharePoint-lijst voor het beheren van compensatie-uren.
         * Bevat velden zoals de medewerker, het tijdstip en de status van de compensatie-uren.
         */
        "CompensatieUren": {
        ...
        /**
         * @section UrenPerWeek
         * @description Definieert het standaardschema van werkuren per week voor medewerkers.
         * Vergelijkbaar met CompensatieUrenPerWeek, maar waarschijnlijk voor reguliere werktijden.
         */
        "UrenPerWeek": {
