...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="help-section">
                <h2>💡 Hoe gebruik je deze tester?</h2>
                <ul>
                    <li><strong>Week A startdatum:</strong> Kies een maandag waarop Week A begint (bijvoorbeeld volgende week maandag)</li>
                    <li><strong>Week schema's:</strong> Stel in welke dagen u in Week A en Week B werkt</li>
                    <li><strong>Bekijk resultaat:</strong> Zie hieronder hoe de komende 4 weken eruit zien</li>
                    <li><strong>Tevreden?</strong> Ga terug naar <a href="../instellingenCentrum/instellingenCentrumN.aspx" style="color: #3498db; text-decoration: none; font-weight: 600;">Persoonlijke Instellingen → Werktijden</a> en vul dezelfde gegevens in</li>
                </ul>
            </div>

            <div class="controls-section">
                <h2>⚙️ Uw roulerende schema instellen</h2>
                
                <div class="form-grid">
                    <div class="form-group">
                        <label for="cycleStartDate">📅 Op welke maandag begint Week A?</label>
                        <input type="date" id="cycleStartDate" value="2025-07-07">
                        <small style="color: #6c757d; margin-top: 5px;">Kies bij voorkeur een maandag in de nabije toekomst</small>
                    </div>
                </div>

                <div class="week-config">
                    <div class="week-block week-a">
                        <h3>Week A - Wat werk je deze week?</h3>
                        <div class="day-config">
                            <div class="day-row">
                                <span class="day-label">Maandag:</span>
                                <select id="weekA-monday" class="day-select">
                                    <option value="Normaal" selected>Gewoon werken</option>
                                    <option value="VVM">Vrije voormiddag</option>
                                    <option value="VVD">Niet werken</option>
                                    <option value="Flexibel">Flexibele tijd</option>
                                </select>
                            </div>
                            <div class="day-row">
                                <span class="day-label">Dinsdag:</span>
                                <select id="weekA-tuesday" class="day-select">
                                    <option value="Normaal" selected>Gewoon werken</option>
                                    <option value="VVM">Vrije voormiddag</option>
                                    <option value="VVD">Niet werken</option>
                                    <option value="Flexibel">Flexibele tijd</option>
                            ...
                            <div class="day-row">
                                <span class="day-label">Woensdag:</span>
                                <select id="weekA-wednesday" class="day-select">
                                    <option value="Normaal" selected>Gewoon werken</option>
                                    <option value="VVM">Vrije voormiddag</option>
                                    <option value="VVD">Niet werken</option>
                                    <option value="Flexibel">Flexibele tijd</option>
                            ...
                            <div class="day-row">
                                <span class="day-label">Donderdag:</span>
                                <select id="weekA-thursday" class="day-select">
                                    <option value="Normaal" selected>Gewoon werken</option>
                                    <option value="VVM">Vrije voormiddag</option>
                                    <option value="VVD">Niet werken</option>
                                    <option value="Flexibel">Flexibele tijd</option>
                            ...
                            <div class="day-row">
                                <span class="day-label">Vrijdag:</span>
                                <select id="weekA-friday" class="day-select">
                                    <option value="VVD" selected>Niet werken</option>
                                    <option value="Normaal">Gewoon werken</option>
                                    <option value="VVM">Vrije voormiddag</option>
                                    <option value="Flexibel">Flexibele tijd</option>
                                </select>
                            </div>
                    ...
                    <div class="week-block week-b">
                        <h3>Week B - Wat werk je deze week?</h3>
                        <div class="day-config">
                            <div class="day-row">
                                <span class="day-label">Maandag:</span>
                                <select id="weekB-monday" class="day-select">
                                    <option value="VVD" selected>Niet werken</option>
                                    <option value="Normaal">Gewoon werken</option>
                                    <option value="VVM">Vrije voormiddag</option>
                                    <option value="Flexibel">Flexibele tijd</option>
                            ...
                            <div class="day-row">
                                <span class="day-label">Dinsdag:</span>
                                <select id="weekB-tuesday" class="day-select">
                                    <option value="Normaal" selected>Gewoon werken</option>
                                    <option value="VVM">Vrije voormiddag</option>
                                    <option value="VVD">Niet werken</option>
                                    <option value="Flexibel">Flexibele tijd</option>
                            ...
                            <div class="day-row">
                                <span class="day-label">Woensdag:</span>
                                <select id="weekB-wednesday" class="day-select">
                                    <option value="Normaal" selected>Gewoon werken</option>
                                    <option value="VVM">Vrije voormiddag</option>
                                    <option value="VVD">Niet werken</option>
                                    <option value="Flexibel">Flexibele tijd</option>
                            ...
                            <div class="day-row">
                                <span class="day-label">Donderdag:</span>
                                <select id="weekB-thursday" class="day-select">
                                    <option value="Normaal" selected>Gewoon werken</option>
                                    <option value="VVM">Vrije voormiddag</option>
                                    <option value="VVD">Niet werken</option>
                                    <option value="Flexibel">Flexibele tijd</option>
                            ...
                            <div class="day-row">
                                <span class="day-label">Vrijdag:</span>
                                <select id="weekB-friday" class="day-select">
                                    <option value="Normaal" selected>Gewoon werken</option>
                                    <option value="VVM">Vrije voormiddag</option>
                                    <option value="VVD">Niet werken</option>
                                    <option value="Flexibel">Flexibele tijd</option>
                ...
                <div style="text-align: center; margin-top: 20px;">
                    <button class="btn" onclick="updateRoster()">🔄 Laat mijn rooster zien</button>
                </div>
            </div>

            <div class="roster-view">
                <h2>📅 Zo ziet uw rooster eruit (komende 4 weken)</h2>
    ...
    <script>
        ...
        function calculateWeekType(targetDate, cycleStartDate) {
            ...
            // We gebruiken maandag als start van de week
            ...
            // Behandel negatieve weken (datums voor cyclus start) correct
            // Even weken = A, Oneven weken = B (gebruik wiskundige modulo voor negatieven)
            ...
            return {
                ...
                daysSinceCycleStart: Math.floor(timeDiff / (24 * 60 * 60 * 1000))
            };
        }
        ...
        function updateRoster() {
            ...
            if (!cycleStartInput) {
                alert('Vul de startdatum van Week A in!');
                return;
            }

            const cycleStartDate = new Date(cycleStartInput);
            
            // Start altijd op de komende maandag voor de weergave
            const today = new Date();
            const testStartDate = new Date(today);
            const dayOfWeek = today.getDay();
            const daysUntilMonday = dayOfWeek === 0 ? 1 : (8 - dayOfWeek);
            testStartDate.setDate(today.getDate() + daysUntilMonday);
            ...
            for (let week = 0; week < 4; week++) {
                const weekStartDate = new Date(testStartDate);
                weekStartDate.setDate(testStartDate.getDate() + (week * 7));
                ...
                rosterHTML += `
                    <div class="week-display week-type-${weekType.toLowerCase()}">
                        <div class="week-header">
                            Week ${week + 1}: Week ${weekType} - ${formatDutchDate(weekStartDate)}
                        </div>
                        <div class="days-grid">
                            <div class="day-cell day-header weekend">Zo</div>
                            ...
                            <div class="day-cell day-header weekend">Za</div>
                `;
                ...
                for (let day = 0; day < 7; day++) {
                    ...
                    if (!isWeekend) {
                        const workday = workdays[day - 1]; // Adjust for Monday = index 0
                        const dayType = config[workday];
                        dayTypeClass = dayType.toLowerCase();
                        dayTypeText = dayType;
                    } else {
                    ...
                    rosterHTML += `
                        <div class="day-cell ${isWeekend ? 'weekend' : ''}">
                            <div class="day-content">
                                ...
                                <div class="day-type ${dayTypeClass}">${dayTypeText}</div>
                            </div>
                        </div>
                    `;
                }
