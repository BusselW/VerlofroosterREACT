...
export const beheerTabs = [
    // Medewerkers - Employee management
    {
        ...
        columns: [
            ...
            { Header: 'Werkschema', accessor: 'Werkschema', type: 'text' },
            { Header: 'Halve dag type', accessor: 'HalveDagType', type: 'text' },
            { Header: 'Halve dag weekdag', accessor: 'HalveDagWeekdag', type: 'text' },
